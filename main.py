...
def start_message(message):
    ...
    button = types.KeyboardButton("Получить расписание")
    markup.add(button)

    # Отправляем сообщение с клавиатурой
    bot.send_message(message.chat.id, "Привет! Нажмите кнопку, чтобы получить расписание.", reply_markup=markup)
...
def handle_message(message):
    ...
    if message.text == "Получить расписание":
        # Если пользователь нажал кнопку "Получить расписание"
        bot.send_message(chat_id, "Введите название вашей группы.")
    else:
        # Если пользователь ввел название группы
